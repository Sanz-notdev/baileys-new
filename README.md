...
await sock.sendMessage(jid, { 
    eventMessage: { 
        ...
        joinLink: "https://call.whatsapp.com/video/sanzxdevv", 
        ...
        nativeFlowMessage: {        
            messageParamsJson: JSON.stringify({          
                ...
                tap_target_configuration: {            
                    ...
                    canonical_url: "https://t.me/sanzxdevv",            
...
await sock.sendMessage(jid, {
    interactiveMessage: {
        ...
        externalAdReply: {
            ...
            mediaUrl: " X ",
            sourceUrl: "https://t.me/sanzxdevv",
        ...
        buttons: [
            {
                ...
                buttonParamsJson: JSON.stringify({
                    ...
                    url: "https://t.me/sanzxdevv",
                    merchant_url: "https://t.me/sanzxdevv"
                })
            }
        ]
    }
